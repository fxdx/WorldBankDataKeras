...
class TestSum(unittest.TestCase):
    ...
    def test_import_population1(self):
        xls_parsing_object = data.XLSParsing('Aruba')
    ...
    def test_import_population2(self):
        xls_parsing_object = data.XLSParsing('France')
    ...
    def test_import_co2_emissions1(self):
        xls_parsing_object = data.XLSParsing('Poland')
    ...
    def test_import_co2_emissions2(self):
        xls_parsing_object = data.XLSParsing('Sweden')
